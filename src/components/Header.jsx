        ...
        <div className="relative">
          ...
          >
            <div className="flex flex-col text-right hidden md:block">
              ...
              <span className="text-[10px] text-blue-500/50 font-medium uppercase tracking-wider">
                Super Admin
              </span>
            </div>
            <img
            ...
            />
            <FaChevronDown
              className={`text-blue-400 text-xs transition-all duration-500 ${isProfileOpen ? "rotate-180 text-blue-300" : ""}`}
            />
          </div>
